...
reff[0]=crcarray1[522];

reff[1]=crcarray3[522];

reff[2]=crcarray5[522];
...
crcarray5[522]=(ack[1]+2)%5;
	...
	te=send(client_fd[0],crcarray1, sizeof(crcarray1),0);
 		 	  ...
 		 	  cout<<"send1"<<te<<"bytes:"<<crcarray1[522]<<endl;

//} 		 	  

//if(reff[1]==crcarray3[522])
...
/*	if(ack[2]==3)
...

	{
				...
				if(ack[1]==crcarray1[522])
				
					{
						...
						for(int k=1;k<=520;k++)	
							...
							d_crcarray[521]=crcarray1[522];
							
							d_crcarray[522]=crcarray1[522];
					
					}
					
				
				if(ack[1]==crcarray3[522])
				
					{
						...
						d_crcarray[521]=crcarray3[522];
							
						d_crcarray[522]=crcarray3[522];
					
					}	

				
				if(ack[1]==crcarray5[522])
				
					{
						...
						d_crcarray[k]=mod3[k];
							...
							d_crcarray[521]=crcarray5[522];
							
							d_crcarray[522]=crcarray5[522];
		...
		while(ack[0]==2 || ret==0)
			 ...
			 for(int sh=1;sh<=522;sh++)
		
			  crcarray11[sh]=d_crcarray[sh];
				...
				*/
				...
				int te1=send(client_fd[0],crcarray11, sizeof(crcarray11),0);
 		 	  
 		 	  	cout<<"send"<<te1<<"bytes"<<endl;
				...
				struct timeval tv;
 				...
 				ret = select(client_fd[0]+1, &rfds, NULL, NULL, &tv);
				...
				retvala1=recv(client_fd[0],ack,3*sizeof(int),0);
		
				cout<<"received"<<retvala1<<endl;
					...
					
			{
			 ...
			 cout<<ccc<<"frames sent successfully\n";
